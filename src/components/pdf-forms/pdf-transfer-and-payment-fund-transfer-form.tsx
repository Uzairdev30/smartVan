  ...
  list: [
    {
      ...
      description: [
        ...
        {
          isClosure: true,
          text: 'في حال حدوث أي تأخير أو فقدان أو خطأ من قبل البنوك المراسلة أو وكلائكم، أتحمل/نتحمل كامل المخاطر المرتبطة، علمًا بأن البنك يتخذ كافة إجراءات الحيطة والحذر اللازمة باستخدام أفضل الوسائل الآمنة المتاحة.',
        },
        {
          isClosure: true,
...
export function TransferPaymentFundTransferForm({ data }: InvoicePDFDocumentProps): React.JSX.Element {
        ...
        <View style={styles.column}>
          ...
          <View style={{...styles.row,alignItems:'center'}}>
                     <View style={{ width: '50%', display: 'flex', flexDirection: 'column' }}>
                       ...
                       <CheckBoxComp label={formdetails?.tpFundTranferTypeOfRemittance?.value} val={formdetails?.tpFundTranferTypeOfRemittance?.value}/>
                     ...
                     <View style={{ width: '50%', display: 'flex', flexDirection: 'column' }}>
                       <Text style={[styles.arabicLabel, { fontSize: 9 }]}>نوع التحويل المالي :</Text>
                       <CheckBoxComp direction={'rtl'} val={formdetails?.tpFundTranferTypeOfRemittance?.value} label={formdetails?.tpFundTranferTypeOfRemittance?.value}/>
          ...
          <View style={{ flexDirection: 'column'}}>
            ...
            <DualLabelField
              labelEN="Currency"
              labelAR="العملة"
              value={formdetails?.tpPaymentBenificiaryCurrency?.value || 'N/A'}
            />
            <DualLabelField
              labelEN="Amount in Figures"
              labelAR="المبلغ باألرقام"
              value={formdetails?.tpPaymentBenificiaryAmountFigures || 'N/A'}
            />
            <DualLabelField
              labelEN="Amount in Words"
              labelAR="المبلغ بالحروف"
              value={formdetails?.tpPaymentBenificiaryAmountWords || 'N/A'}
            />

            <DualLabelField
              labelEN="Beneficiary Account No./IBAN"
              labelAR="رقم حساب المستفيد/ أيبان"
              value={formdetails?.tpPaymentBenificiaryAccNoOrIBAN || 'N/A'}
            />
            <DualLabelField
              labelEN="Beneficiary Name"
              labelAR="اسم المستفيد"
              value={formdetails?.tpPaymentBenificiaryName || 'N/A'}
            />
            <DualLabelField
              labelEN="Beneficiary Bank"
              labelAR="بنك المستفيد"
              value={formdetails?.tpPaymentBenificiaryBank || 'N/A'}
            />
            <DualLabelField
              labelEN="Swift Code/Sort Code/ABA #"
              labelAR="رمز سويفت / رمز التصنيف / ABA #"
              value={formdetails?.tpPaymentBenificiarySwiftCode || 'N/A'}
            />
            <DualLabelField
              labelEN="Address of Bank"
              labelAR="عنوان البنك"
              value={formdetails?.tpPaymentBenificiarAddressBank || 'N/A'}
            />
            <DualLabelField
              labelEN="Correspondent Bank"
              labelAR="البنك المراسل"
              value={formdetails?.tpPaymentBenificiarCorrespondentBank || 'N/A'}
            />
            <DualLabelField
              labelEN="Swift Code/Sort Code/ABA #"
              labelAR="رمز سويفت / رمز التصنيف / ABA #"
              value={formdetails?.tpPaymentBenificiaryCorrespondentSwiftCode || 'N/A'}
            />
          </View>

          <View style={[styles.customRow, { gap: '40px', marginTop: 3 }]}>
            <DualCheckbox
              labelEN="Credit Card Payments"
              labelAR="دفعات بطاقة الائتمان"
              isChecked={formdetails?.tpPaymentMethods?.id === 491}
            />
            <DualCheckbox
              labelEN="Charitable Contributions"
              labelAR="تبرعات خيرية"
              isChecked={formdetails?.tpPaymentMethods?.id === 492}
            />
            <DualCheckbox labelEN="Remittance" labelAR="تحويل" isChecked={formdetails?.tpPaymentMethods?.id === 493} />
            <DualCheckbox
              labelEN="Cross Border Payments"
              labelAR="دفعات عبر الحدود"
              isChecked={formdetails?.tpPaymentMethods?.id === 494}
            />
          </View>
          ...
          <View style={[styles.customRow, { justifyContent: 'space-between', marginTop: 5 }]}>
              ...
              <View style={[styles.customRow, { width: '100%', justifyContent: 'center' }]}>
                <View style={styles.checkboxRow}>
                  <View
                    style={[
                      styles.checkbox,
                      // { backgroundColor: formdetails?.tpRemittanceChargesBorneBy?.id === 292 ? '#6E2B8C' : '' },
                    ]}
                  >{ formdetails?.tpRemittanceChargesBorneBy?.id === 292 ? <Text style={styles.tickMark}>{'\u2713'}</Text> : null}</View>
                  <Text style={styles.secondLabel}>Remitter</Text>
                </View>
                {/* <CheckBoxComp label={formdetails?.tpRemittanceChargesBorneBy?.value} val={formdetails?.tpRemittanceChargesBorneBy?.value} /> */}
                {/* <CheckBoxComp label={formdetails?.tpRemittanceChargesBorneBy?.value} val={formdetails?.tpRemittanceChargesBorneBy?.value} /> */}
                ...
                <View style={styles.checkboxRow}>
                  <View
                    style={[
                      styles.checkbox,
                      // { backgroundColor: formdetails?.tpRemittanceChargesBorneBy?.id === 293 ? '#6E2B8C' : '' },
                    ]}
                  >{ formdetails?.tpRemittanceChargesBorneBy?.id === 293 ? <Text style={styles.tickMark}>{'\u2713'}</Text> : null}</View>
            ...
            <View style={[styles.customRowAR, { gap: '10px', width: '50%' }]}>
              ...
              <View style={[styles.customRowAR, { width: '100%', justifyContent: 'center' }]}>
                ...
                {/* <CheckBoxComp direction={"rtl"} label={formdetails?.tpRemittanceChargesBorneBy?.value} val={formdetails?.tpRemittanceChargesBorneBy?.value} /> */}
                ...
                <View style={styles.checkboxRow}>
                  ...
                  <View
                    style={[
                      ...
                      // {
                        // backgroundColor:
                          // formdetails?.tpRemittanceChargesCorrespondentBankCharges?.id === 292 ? '#6E2B8C' : '',
                      // },
                    ]}
                  >{formdetails?.tpRemittanceChargesCorrespondentBankCharges?.id === 292 ? <Text style={styles.tickMark}>{'\u2713'}</Text> : null}</View>
                </View>
                ...
                <View style={styles.checkboxRow}>
                  ...
                  <View
                    style={[
                      ...
                      // {
                      //   backgroundColor:
                      //     formdetails?.tpRemittanceChargesCorrespondentBankCharges?.id === 293 ? '#6E2B8C' : '',
                      // },
                    ]}
                  >{formdetails?.tpRemittanceChargesCorrespondentBankCharges?.id === 293 ? <Text style={styles.tickMark}>{'\u2713'}</Text> : null}</View>
                </View>
              </View>
            </View>
          </View>
          ...
          <View style={{ flexDirection: 'column', gap: '2px'}}>
            ...
            <View style={[styles.customRow, { justifyContent: 'space-between' }]}>
              ...
              <CheckBoxComp label="Debit My Account Number" val={formdetails?.tpModeOfPaymentDebitMyAccNum} />
              <AccountBoxes data={formdetails?.tpModeOfPaymentDebitMyAccNum?.split('')} />

              {/* <View style={{ display: 'flex', flexDirection: 'row' }}>
                {formdetails?.tpModeOfPaymentDebitMyAccNum?.split('')?.map((item: any, index: any) => {
              ...
              <View style={styles.checkboxRowAr}>
                <CheckBoxComp direction={'rtl'} label="حسم من حساب رقم" val={formdetails?.tpModeOfPaymentDebitMyAccNum}/>
                {/* <View style={[styles.checkbox, { backgroundColor: '#6E2B8C' }]}></View>
            ...
            <View style={{ flexDirection: 'column', gap: '0px' }}>
              {/* <DualLabelField labelEN="Customer Name" labelAR="اسم العميل" value={formdetails?.tpPaymentBenificiaryName}/> */}
              <DualLabelField
                labelEN="Applicant Contact No 1"
                labelAR="رقم هاتف مقدم الطلب"
                value={
                  formdetails?.tpModeOfPaymentApplicantContactNo1 ||
                  // formdetails?.tpModeOfPaymentApplicantContactNo2 ||
                  'N/A'
                }
              />
              <DualLabelField
                labelEN="Applicant Contact No 2"
                labelAR="رقم هاتف مقدم الطلب"
                value={
                  // formdetails?.tpModeOfPaymentApplicantContactNo1 ||
                  formdetails?.tpModeOfPaymentApplicantContactNo2 ||
      ...
      <Page size="A4" style={styles.page}>
              ...
              <View style={[styles.row, { marginTop: 5,gap:"5%" }]}>
                ...
                >
                  ...
                  <View style={{ flexDirection: 'row', gap: 5, alignItems: 'flex-start', marginLeft: 5 }}>

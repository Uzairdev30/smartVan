    ...
    <Drawer
      PaperProps={{
        sx: {
          ...
          '--NavItem-active-background': '#191970',
          ...
          '--Workspaces-background': '#F6F7F9',
          '--Workspaces-border-color': 'var(--mui-palette-neutral-700)',
          '--Workspaces-title-color': 'var(--mui-palette-neutral-600)',
          '--Workspaces-name-color': 'var(--mui-palette-neutral-900)',
          '--Workspaces-expand-color': 'var(--mui-palette-neutral-500)',

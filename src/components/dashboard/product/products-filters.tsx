...
export function ProductsFilters({ filters = {}, sortDir = 'desc', open }: ProductsFiltersProps): React.JSX.Element {
  ...
  return (
    ...
    // padding of catgory and card and create new offer described here !!!!!


    <div style={{ width: '100%', paddingLeft: "20px", paddingRight: "20px", paddingTop: "16px", paddingBottom: "16px" }}>
      ...
      {/* <Divider /> */}
      {/* <Stack direction="row" spacing={2} sx={{ alignItems: 'center', flexWrap: 'wrap', p: 2, gap: '16px' }}> */}


      <Box sx={{ display: "flex", flexDirection: "row", justifyContent: "space-between", width: '100%' }}>
        <ProductsFilters />
        <Stack direction="row" sx={{ alignItems: 'center', flex: '1 1 auto', flexWrap: 'wrap', gap: "16px" }}>
          {/* spacing={2} */}
          <FilterButton
          ...
          />
          {/* Only name SKU change here further changes required */}
          <FilterButton
          ...
          />
          {/* <Button onClick={handleClearFilters} sx={{color:"#1976D2"}}>Clear filters</Button> */}
